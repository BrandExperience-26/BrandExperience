...
const defaultAssets: MediaAssets = {
  logoLight: "/images/logo-fundo-claro.png",
  logoDark: "/images/logo-fundo-escuro.png",
  ...
  return (
    <div className="site-shell">
      <header className="site-header">
        <a className="site-header__brand" href="#top" onClick={closeMenu}><BrandMark light logo={assets.logoDark} /></a>
